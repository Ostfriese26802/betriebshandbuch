...
class MonitoringsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monitoring" do
    assert_difference('Monitoring.count') do
      post monitorings_url, params: { monitoring: { beschreibung: @monitoring.beschreibung, name: @monitoring.name, werte: @monitoring.werte } }
    end
  ...
  test "should update monitoring" do
    patch monitoring_url(@monitoring), params: { monitoring: { beschreibung: @monitoring.beschreibung, name: @monitoring.name, werte: @monitoring.werte } }
